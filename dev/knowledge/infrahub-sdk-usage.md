...
`self.wrapper.client` is two layers deep by design and collapsible-looking. It was "fixed" once during
the inventory performance work and broke tests. Verify with
