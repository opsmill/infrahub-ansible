...
Before using the Infrahub node modules, you need to configure the connection to your Infrahub instance. All node operations require:
...
```yaml
- name: Create node with direct parameters
