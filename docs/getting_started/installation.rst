...
1. ``git clone git@github.com:opsmill/infrahub-ansible.git``
2. ``cd ansible_modules``
3. ``ansible-galaxy collection build .``
4. ``ansible-galaxy collection install opsmill-infrahub*.tar.gz``
...
6. ``ansible-galaxy collection install opsmill-infrahub*.tar.gz``
